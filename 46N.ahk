...
PressButton("46UniquePicture.png", 540, 60)
PressButton("46NormalBattle.png", 99, 48)
...
BattlePath:
	Loop {
	Tooltip, Searching for 4-6StartOperation.PNG, 0, 0, 1
	WinActivate BlueStacks
	ImageSearch, , , 0, 0, A_ScreenWidth, A_ScreenHeight, 46StartOperation.PNG
		if ErrorLevel = 2
		{
		MsgBox Error encountered searching for 46StartOperation.PNG
		}
		else if Errorlevel = 1
		{
		Tooltip, 46StartOperation.PNG not found, 0, 23, 2
		Goto DisassemblePath
		}
		else
		{
		Tooltip, 46StartOperation.PNG found, 0, 23, 2
		Goto Battle
		}
	}

Battle:
PressNodeWhen("46CommandPost.png", 680, 50, 730, 55)
PressButton("46OK.png", 104, 40)
PressButton("46CommandPost.png", 36, 37)
PressButton("46OK.png",104, 40)
PressNodeWhen("46Echelon2Placed.png", 644, 585, 716, 652)
TimedSleep(4)
DoublePressNodeWhen("46Echelon2Placed.png", 660, 480, 695, 520)
PressButton("Resupply.png", 125, 39)
DragUntil("46TopOfMap.png", 410, 95, 620, 285, 20)
PressButton("PlanningModeUnclicked.png", 90, 25)
PressNode(695, 135, 720, 165)
PressNode(545, 135, 565, 155)
PressNode(435, 140, 455, 160)
PressNode(290, 145, 320, 175)
PressNode(125, 135, 160, 170)
PressButton("46ExecutePlan.png", 103, 53)
PressNodeWhen("46AllBattlesCompleted.png", 707, 596, 808, 647)
PressNodeCheck("Reward2.png", "46Reward1.png", 10, 50, 820, 655)
PressNodeWhen("Reward2.png", 110, 110, 820, 655)
PressNodeWhen("46Reward1.png", 10, 50, 820, 655)
...
FN := Randomize(1,4)
TimedSleep(FN)
Formation("Dolls/ST-AR15.PNG", "Dolls/FAL.PNG", 7, 6)
